...
|----------------------|-------------|--------|---------------|---------|--------|----------------------------------|
| **Our ViT (CNN-Patchified)** | **2.3**       | **300M** | **93.32**     | **50**   | [Google Colab](https://colab.research.google.com/drive/1h3izwUoPyt32RBHETmTsk0GpiQ-N4-Yh?usp=sharing) | Only replaces raw patches with CNN-based patch embedding (adds inductive bias); rest of architecture similar to standard ViT |
