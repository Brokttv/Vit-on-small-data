...
|----------------------|-------------|--------|---------------|---------|--------|----------------------------------|
| **Our ViT (CNN-Patchified)** | **2.38**       | **300M** | **93.42**     | **50**   | [Google Colab](https://colab.research.google.com/drive/1mmhjZ6dS69L9zK99P8OJKXaEfWZtskTm?usp=sharing) | Only replaces raw patches with CNN-based patch embedding (adds inductive bias); rest of architecture similar to standard ViT |
